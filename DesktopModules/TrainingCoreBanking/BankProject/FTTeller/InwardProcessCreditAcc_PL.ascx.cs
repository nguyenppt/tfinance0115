...
namespace BankProject.FTTeller
{
    public partial class InwardProcessCreditAcc_PL : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        ...
        protected void radGridReview_OnNeedDataSource(object sender, GridNeedDataSourceEventArgs e)
        {
            ...
            dr["ReperenceNo"] = "TT/09164/00607";
            dr["BOName"] = "Đỗ Bảo Lộc";
            dr["FOName"] = "Nguyễn Văn Trung";
            dr["DebitAmtLCY"] = "6,000,000";
            dr["CrbitAmtLCY"] = "6,000,000";
            dr["Status"] = "UNA";
            dr["LCCode"] = "1";
            dt.Rows.Add(dr);

            DataRow dr1 = dt.NewRow();
            dr1["ReperenceNo"] = "TT/09164/00608";
            dr1["BOName"] = "Trẩn Bửu Thạch";
            dr1["FOName"] = "Tô Văn Hoa";
            dr1["DebitAmtLCY"] = "23,000,000";
            dr1["CrbitAmtLCY"] = "23,000,000";
            dr1["Status"] = "UNA";
            dr1["LCCode"] = "2";
            dt.Rows.Add(dr1); 

            DataRow dr2 = dt.NewRow();
            dr2["ReperenceNo"] = "TT/09164/00609";
            dr2["BOName"] = "Trần Minh Tâm";
            dr2["FOName"] = "Lý Thánh Tông";
            dr2["DebitAmtLCY"] = "50,000,0000";
            dr2["CrbitAmtLCY"] = "50,000,0000";
            dr2["Status"] = "UNA";
            dr2["LCCode"] = "3";
            dt.Rows.Add(dr2);
