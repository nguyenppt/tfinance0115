<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ListReview.ascx.cs" Inherits="BankProject.TellerApplication.AccountManagement.SavingsAC.Open.ListReview" %>
