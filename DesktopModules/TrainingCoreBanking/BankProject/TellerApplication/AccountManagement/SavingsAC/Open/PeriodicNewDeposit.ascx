<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PeriodicNewDeposit.ascx.cs" Inherits="BankProject.TellerApplication.AccountManagement.SavingsAC.Open.PeriodicNewDeposit" %>
