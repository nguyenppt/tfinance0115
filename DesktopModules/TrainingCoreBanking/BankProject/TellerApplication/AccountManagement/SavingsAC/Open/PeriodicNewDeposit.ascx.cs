...
{
    public partial class PeriodicNewDeposit : DotNetNuke.Entities.Modules.PortalModuleBase
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            radAcctNo.Text = "070001688380*" + DateTime.Now.ToString("yyyyMMdd") + "*BO";
        ...
        protected void RadToolBar1_ButtonClick(object sender, RadToolBarEventArgs e)
        {
            ...
            {
                Response.Redirect("Default.aspx?tabid=146&Preview=1 ");
            }
        }
