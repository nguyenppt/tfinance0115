<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PreclosureDisplay.ascx.cs" Inherits="BankProject.TellerApplication.AccountManagement.SavingsAC.Close.PreclosureDisplay" %>
...
<div class="dnnForm" id="tabs-demo">
    <ul class="dnnAdminTabNav">
        <li><a href="#Preclose">Pre close view</a></li>
    </ul>
                ...
                <tr>
                    ...
                    <td class="MyContent">
                        <telerik:RadDatePicker ID="dtpValueDate" Width="130" runat="server" MinDate="1/1/1900" MaxDate="1/12/9999" 
                            DateInput-DateFormat="dd/MM/yyyy" DateInput-ClientEvents-OnBlur="dtpValueDate_DateSelected">
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    <script type="text/javascript">
        ...
        function OnClientButtonClicking(sender, args) {
            ...
            if (button.get_commandName() == "commit") {
                if (!clickCalledAfterRadconfirm) {
                    ...
                    var totalAmt = Number($('#<%= hdfTotal.ClientID %>').val());
                    if (PreclosureType != "1") {
        ...
        function dtpValueDate_DateSelected(sender, eventArgs) {
            ...
            var today = ValueDate.get_selectedDate();
            ...
            if (PreclosureType == "1") {
                ...
                $('#<%= hdfTotal.ClientID %>').val(Number(totalInAmt) + 50000000);
                ...
                $('#<%= hdfTotalAmt.ClientID %>').val(totalInAmt);
                $('#<%= hdfTotal.ClientID %>').val(Number(totalInAmt) + 250000000);
...
<asp:HiddenField ID="hdfTotal" runat="server" Value="0" />