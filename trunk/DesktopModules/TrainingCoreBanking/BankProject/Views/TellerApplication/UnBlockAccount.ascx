<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnBlockAccount.ascx.cs" Inherits="BankProject.Views.TellerApplication.UnBlockAccount" %>
            ...
            <td style="width: 200px; padding: 5px 0 5px 20px;">
                <asp:TextBox ID="txtId" runat="server" Width="200" />
                    <asp:RequiredFieldValidator
                        ...
                        InitialValue=""
                        ErrorMessage="Account is Required" ForeColor="Red">
                    </asp:RequiredFieldValidator>
                <i>
      ...
      <table width="100%" cellpadding="0" cellspacing="0">
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td class="MyContent">
                    <telerik:RadNumericTextBox ID="txtAmount" runat="server" ValidationGroup="Group1" />
                </td>
            </tr>
