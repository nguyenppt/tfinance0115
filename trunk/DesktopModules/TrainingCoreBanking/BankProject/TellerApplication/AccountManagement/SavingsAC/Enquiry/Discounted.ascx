<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Discounted.ascx.cs" Inherits="BankProject.TellerApplication.AccountManagement.SavingsAC.Enquiry.Discounted" %>
