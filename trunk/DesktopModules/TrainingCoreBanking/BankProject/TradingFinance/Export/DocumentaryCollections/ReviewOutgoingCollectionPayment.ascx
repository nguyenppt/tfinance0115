<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReviewOutgoingCollectionPayment.ascx.cs" Inherits="BankProject.TradingFinance.Export.DocumentaryCollections.ReviewOutgoingCollectionPayment" %>
