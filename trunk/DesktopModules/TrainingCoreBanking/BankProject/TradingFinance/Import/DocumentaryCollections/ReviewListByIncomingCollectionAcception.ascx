<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ReviewListByIncomingCollectionAcception.ascx.cs" Inherits="BankProject.TradingFinance.Import.DocumentaryCollections.ReviewListByIncomingCollectionAcception" %>
